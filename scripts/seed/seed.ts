...
async function seedProperties() {
  ...
  for (const property of properties) {
    ...
    const doc = {
      ...
      listingCategory: property.listingCategory || "sale",
      propertyType: property.propertyType,
      landSize: property.landSize,
      landSizeAcres: property.landSizeAcres,
      landPurpose: property.landPurpose,
      furnished: property.furnished,
      depositAmount: property.depositAmount,
      availableFrom: property.availableFrom,
      petsAllowed: property.petsAllowed,
      titleDeedReady: property.titleDeedReady,
      ...
      hasStaffQuarters: property.hasStaffQuarters,
      hasGarden: property.hasGarden,
      hasBackupPower: property.hasBackupPower,
      roadAccess: property.roadAccess,
      fenced: property.fenced,
      waterSource: property.waterSource,
      cropsSuitable: property.cropsSuitable,
